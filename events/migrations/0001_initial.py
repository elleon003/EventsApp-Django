# Generated by Django 4.1.13 on 2024-03-10 03:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='event',
            index=models.Index(fields=['id', 'slug'], name='events_even_id_e6ebd0_idx'),
        ),
        migrations.AddIndex(
            model_name='event',
        ...
        migrations.AddIndex(
            model_name='event',
            index=models.Index(fields=['-created'], name='events_even_created_a68720_idx'),
        ),
    ]
